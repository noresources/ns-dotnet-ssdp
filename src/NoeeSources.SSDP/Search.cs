...
namespace NoeeSources.SSDP
{
	...
	public class SearchRequest : Message
	{
		...
		/// </summary>
		/// <returns>A <see cref="T:System.String"/> that represents the current <see cref="T:NoeeSources.SSDP.SearchRequest"/>.</returns>
	...
	public class SearchResponse : Message
	{
		...
		/// </summary>
		/// <returns>A <see cref="T:System.String"/> that represents the current <see cref="T:NoeeSources.SSDP.SearchResponse"/>.</returns>
		public override string ToString()
		{
